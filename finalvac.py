...
if Menu == "Home":
    ...
    with tab2:
        ...
        with col1:
            ...
            df2_e = df2_e.dropna(subset=["income_level", "marital_status", "housing_status", "h1n1_vaccine"])

            df2_e = df2_e.fillna({
             "income_level": "Unknown",
             "marital_status": "Unknown",
             "housing_status": "Unknown",
                "h1n1_vaccine": 0  # Or another appropriate value
                        })

            df2_e["h1n1_vaccine"] = pd.to_numeric(df2_e["h1n1_vaccine"], errors='coerce')
        ...
        with col2:
            ...
            df4_e = df4_e.dropna(subset=["qualification", "race", "employment", "h1n1_vaccine"])
            df4_e["h1n1_vaccine"] = pd.to_numeric(df4_e["h1n1_vaccine"], errors='coerce')
